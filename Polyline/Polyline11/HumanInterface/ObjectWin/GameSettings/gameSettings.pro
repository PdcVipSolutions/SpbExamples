...
clauses
    onRunPBClick(_Source) = button::defaultAction:-
        Container=getTopLevelContainerWindow(),
...
clauses
    ...
    onMultiGameCHBStateChanged(_Source, _OldState, _Checked):-
        ...
        equilityFirstMoveCHB_ctl:setEnabled(true()),
        showStarterName(),
        GameForm=convert(objectWinForm,getContainer()),
...
% This code is maintained automatically, do not update it manually. 12:05:01-20.10.2008
facts
...
clauses
    generatedInitialize():-
        ...
        roundsEC_ctl:setWidth(20),
        roundsEC_ctl:setAutoHScroll(false),
        roundsEC_ctl:setAlignBaseline(false),
        ...
        xSizeIntControl_ctl:setWidth(16),
        xSizeIntControl_ctl:setAutoHScroll(false),
        xSizeIntControl_ctl:setAlignBaseline(false),
        ...
        ySizeIntControl_ctl:setWidth(16),
        ySizeIntControl_ctl:setAutoHScroll(false),
        ySizeIntControl_ctl:setAlignBaseline(false),
        ...
        playerDownPB_ctl:setSize(28, 14),
        ...
        setStarterPB_ctl:setSize(28, 14),
