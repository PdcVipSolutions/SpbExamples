...
clauses
    ...
    inputInvitation(continueMultiGame_S,_StringParameter):-
        console::write(language_V:getText(continueMultiGame_S)).
...
clauses
    ...
    announce(starter_S,Name):-
        ...
        writeMessage(starterLine_C,language_V:getText(starter_S),Name).
    ...
    announce(won_S,Name):-
        ...
        clearMessageArea(announceLine_C),
        clearMessageArea(actionLine_C),
        writeMessage(announceLine_C,language_V:getText(won_S),Name),
        _ = console::readLine().
    announce(loss_S,Name):-
        !,
        clearMessageArea(announceLine_C),
        clearMessageArea(actionLine_C),
        writeMessage(announceLine_C,language_V:getText(loss_S),Name),
        _ = console::readLine().
