...
constants
    ...
    componentID_C:pzlDomains::entityUID_D=pzlDomains::str("PzlComputer1ID").
    componentAlias_C="PzlComputer1".
    componentRunAble_C=b_False.
    componentVersion_C="1.0".
    componentPublicName_C="Computer1".
