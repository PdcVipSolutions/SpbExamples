...
clauses
    getIconByID("open",TaskQueueObj):-
        !,
        IconAsBinary=file::readBinary(@".\febeAppData\pdcVipIcons\actions\document-open.ico"),
        response(be_TakeIconByID_C,b(IconAsBinary),TaskQueueObj).
    getIconByID("new",TaskQueueObj):-
        !,
        IconAsBinary=file::readBinary(@".\febeAppData\pdcVipIcons\actions\document-new.ico"),
        response(be_TakeIconByID_C,b(IconAsBinary),TaskQueueObj).
    getIconByID("save",TaskQueueObj):-
        !,
        IconAsBinary=file::readBinary(@".\febeAppData\pdcVipIcons\actions\document-save.ico"),
        response(be_TakeIconByID_C,b(IconAsBinary),TaskQueueObj).
    getIconByID("undo",TaskQueueObj):-
        !,
        IconAsBinary=file::readBinary(@".\febeAppData\pdcVipIcons\actions\edit-undo.ico"),
        response(be_TakeIconByID_C,b(IconAsBinary),TaskQueueObj).
    getIconByID("redo",TaskQueueObj):-
        !,
        IconAsBinary=file::readBinary(@".\febeAppData\pdcVipIcons\actions\edit-redo.ico"),
        response(be_TakeIconByID_C,b(IconAsBinary),TaskQueueObj).
    getIconByID("copy",TaskQueueObj):-
        !,
        IconAsBinary=file::readBinary(@".\febeAppData\pdcVipIcons\actions\edit-copy.ico"),
        response(be_TakeIconByID_C,b(IconAsBinary),TaskQueueObj).
    getIconByID(Any,TaskQueueObj):-
        IconAsBinary=file::readBinary(@".\febeAppData\pdcVipIcons\status\image-missing.ico"),
...
clauses
    getAllRibbonScriptFiles()=FileDescriptorList:-
        FileDescriptorList=[FileDescriptor||FileName=directory::getFilesInDirectoryAndSub_nd(@".\febeAppData","*.xml"),
