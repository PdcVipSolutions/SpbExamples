...
clauses
    ...
    showStatus(polylineDomains::complete):-
        HumanInterface=convert(humanInterface,getContainer()),
...
% This code is maintained automatically, do not update it manually. 15:20:22-24.5.2010
facts
...
clauses
    generatedInitialize():-
        ...
        viewModePB_ctl:defaultHeight := false(),
        ...
        cleareStatisticsPB_ctl:defaultHeight := false(),
